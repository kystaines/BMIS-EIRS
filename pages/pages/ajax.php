...
if(isset($_POST['table'])){
    ...
    if ($_POST['table'] == 'certificates') {
        ...
        foreach ($result as $row) {
            // Action Buttons
            $process = '<button type="button" class="btn btn-primary btn-sm process" id="' . $row['id'] . '"  data-id="' . $row['fullname'] . '">
            ...
            $approve = '<button type="button" class="btn btn-success btn-sm approve" id="' . $row['id'] . '" data-id="' . $row['fullname']  . '">
            ...
            switch ($row['request_status']) {
                case 'Pending':
                    $status = '<div class="">
                                    <span class="badge badge-warning">' . $row['request_status'] . '</span>
                                </div>';
                    break;
            ...
            switch ($user['user_type']) {
                case 'ADMIN':
                    $action = $process. $approve. $decline. $delete;
                    break;
                case 'STAFF':
                    $action = $process . $approve. $decline;
                    break;                
                default:
                    $action = '';
                    break;
