                ...
                <div class="container-fluid">
                    ...
                    <div class="text-white">
                        ...
                        <p class="text-center text-bold mt-5 h4">
                            ...
                            Its name is derived from Saint Andrew, the patron saint of the city, and the Tagalog word "bukid", meaning "farm" or "rice field".
                            Barangay 775 is a subdivition within San Andres, with a population of 12,084 according to the 2020 census, representing
                            approximately 0.65% of Manila's total population.
                        </p>
                    </div>
                    <div class="row">
                        <div class="col text-center">
                            <img src="../images/logo.png" class=" p-2" alt="Image 1" style="width: 100px; height: 100px">
